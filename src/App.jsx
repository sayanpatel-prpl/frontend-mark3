...
/**
 * Primary sidebar sections — for CD tenants returns CD sidebar,
 * for standard tenants returns sections with ≥1 live item (live items first).
 */
function getPrimarySections(tenantConfig = {}) {
  ...
  // Standard Kompete sidebar — live items first, preview items after
  return [
    {
      key: 'product-intel',
...
/**
 * Explore sections — 100% preview, collapsed by default.
 * Empty for CD tenants.
 */
