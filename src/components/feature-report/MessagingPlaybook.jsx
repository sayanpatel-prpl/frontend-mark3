      ...
      {data.map((item, i) => (
        <div key={i} className="card" style={{ padding: 24 }}>
          <div style={{ display: 'flex', alignItems: 'center', gap: 10, marginBottom: 18 }}>
            <CompanyLogo name={item.company} logoUrl={logoMap[item.company]} size={32} />
            <h4 style={{ fontSize: '1.1rem', color: 'var(--navy)', margin: 0, fontWeight: 700 }}>{item.company}</h4>
          </div>
          ...
          <div style={{ marginBottom: 18 }}>
            ...
            <div style={{
              ...
              padding: '10px 14px', background: 'var(--gray-50)', borderRadius: 6,
              ...
              <div style={{ display: 'flex', flexDirection: 'column', gap: 4 }}>
                {item.key_messages?.map((m, j) => (
                  <div key={j} style={{
                    ...
                    padding: '8px 12px', background: 'var(--gray-50)', borderRadius: 6,
